...
read -p "Confirm grub install was succesful Enter to continue Ctrl-C to quit..."
...
cp /archinstall/4-timeshift.sh /home/$username
cp /archinstall/5-preload.sh /home/$username
